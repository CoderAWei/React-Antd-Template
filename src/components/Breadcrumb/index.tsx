...
export default function BreadCrumb() {
	...
	const handleFlattenRoutes = (routes: IChildRouterMap[]) => routes.reduce((pre, next) => pre.concat(Array.isArray(next.children) ? handleFlattenRoutes(next.children) : next), [])
